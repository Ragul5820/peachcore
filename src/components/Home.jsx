                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
                            {features.map((feature, idx) => (
                                <div key={idx} className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800">
                                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-950/50 flex items-center justify-center">
                        ...
                        <Link
                            to="/about"
                            className="inline-flex items-center px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-slate-950 font-bold rounded-2xl hover:bg-gray-800 dark:hover:bg-gray-100 transition-all hover:shadow-xl hover:-translate-y-1 shadow-lg"
                        >
